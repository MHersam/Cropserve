...
- [ ] Alle zur User Story assoziierten Tests sind erfolgreich.
- [ ] Die Anweisungsüberdeckung der Testfälle beträgt mindestens 75%.
- [ ] Die gesamte Testabdeckung beträgt mindestens 75 %.
- [ ] Unit Tests wurden geschrieben und bestanden.
- [ ] Der Code wurde in Android Studio mit 'Analyze-> Inspect Code' überprüft und redundanter Code entfernt.
- [ ] Der Code ist auf Basis der Java Code Conventions hinreichend kommentiert.
- [ ] Alle assoziierten Dokumente (u.A. Entwurf, Sprint-Report, Read Me) sind vollständig aktualisiert worden.
- [ ] Changelog-Eintrag wurde hinzugefügt.
- [ ] Alle zu den User Stories geöffneten Issues sind erfolgreich geschlossen worden.
- [ ] Jedes bearbeitete Produkt-Inkrement liefert die durch manuelle und instrumentierte Tests getestete(n) erwartete(n) Funktionalität(en).

<!--- To keep the reference if there are any discrepancies later on
